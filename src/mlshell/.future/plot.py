...
class Plotter(Draw):
    def __init__(self, base_plot, params, logger):
        ...
        # TODO: base_plot добавить возможность как kwarg  plot(убери из инициализации).
        #     моё реение как None
        #     сли захотят сами плоттер переделают из датасета.
        #     у нас же выходит для каждого сабсета свой.
        # Create base_plot
        ...
        # TODO: не забудь клонировать пайплайн.
